...
#   e4ster, 12/12/2020, Modified Script
# ---------------------------------------------------------- #
...
class DatabaseProcessor:
    """Manipulates our list of objects.
        ...
        changelog: (When,Who,What)
            RRoot, 1.1.2030, Created Class
            e4ster, 12/12/2020, Modified Class
        """

    @staticmethod
    def add_data_to_list(new_obj, list_of_objects):
        """
        Adds user input to our data table.

        :param new_obj: Employee object created from user input
